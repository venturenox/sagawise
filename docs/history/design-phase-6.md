...
**Status:** agreed and implemented on branch `state-machine`, 2026-09-05. Roadmap phase 6 (`docs/history/TODO.md`). Decisions P1–P7 below were all taken as recommended.
